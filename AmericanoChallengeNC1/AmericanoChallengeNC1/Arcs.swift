...
struct TicketShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addArc(center: CGPoint.zero, radius: 0, startAngle: Angle(degrees: 90), endAngle: Angle(degrees: 0) , clockwise: true)
        ...
        path.addArc(center: CGPoint(x: rect.size.width , y: rect.origin.y), radius: 0, startAngle: Angle(degrees: 180), endAngle: Angle(degrees: 90) , clockwise: true)
